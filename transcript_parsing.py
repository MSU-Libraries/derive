# transcriptinator/transcription/transcript_parsing.py
...
'''
 ...
 the backslash is needed to make sure derivatives folders
 are created in the correct directory
'''
path = '/Users/kudzia/Desktop/transcriptinator/transcription/mp3s/'
...
def create_root(in_file):
    ...
    # this still isn't working and I'm not sure why not
